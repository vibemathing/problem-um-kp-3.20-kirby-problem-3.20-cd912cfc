...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-3.20-kirby-problem-3.20-cd912cfc-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-3.20"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-3.20-kirby-problem-3.20-cd912cfc-v1",
      "problem_contract_sha256": "6b1a3c287278f76246f12d108e8a16d2cce9091b8129e68f20121b9b4b2e200b",
      "problem_id": "problem:um-kp-3.20-kirby-problem-3.20-cd912cfc",
      "route_id": "route:um-kp-3.20-kirby-problem-3.20-cd912cfc-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-3.20-kirby-problem-3.20-cd912cfc-source-fidelity-01",
      "graph_id": "graph:um-kp-3.20-kirby-problem-3.20-cd912cfc-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-3.20-kirby-problem-3.20-cd912cfc-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-3.20-kirby-problem-3.20-cd912cfc-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $M$ be a closed hyperbolic 3-manifold with a faithful homomorphism $\\rho:\\pi_1(M)\\to \\operatorname{Homeo}^{+}(\\mathbb{R})$. Prove that $M$ supports a dual transversely orientable, essential lamination $\\lambda$."
          },
          "statement_sha256": "65f370d272b25bb2a6cb13a458bc78fbed14b586ef1ac1ed1439962caca9c5de"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-3.20-kirby-problem-3.20-cd912cfc-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-3.20-kirby-problem-3.20-cd912cfc-root",
      "route_id": "route:um-kp-3.20-kirby-problem-3.20-cd912cfc-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-3.20-81951fd55fc9",
        "url": "https://www.unsolvedmath.com/problems/KP-3.20"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
